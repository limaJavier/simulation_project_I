...
\subsection{Markov Chain}
    Con los valores originales del problema las probabilidades de que se pierda un cliente en un segundo son: $0.004137817$, la cantidad media de clientes que llegan en un intervalo de longitud $60*60*10$ siguiendo una distribución de Poisson con parámetro 
